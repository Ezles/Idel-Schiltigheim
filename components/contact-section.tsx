...
const ContactSection = () => {
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-6">
        <motion.div
          className="bg-gradient-to-br from-white to-blue-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl shadow-xl p-8 md:p-12 border border-blue-100 dark:border-blue-900 relative overflow-hidden"
        ...
        >
          ...
          <div className="text-center relative z-10">
            <motion.h2
              className="text-3xl md:text-4xl font-bold text-center text-gray-900 dark:text-gray-100 mb-4"
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              viewport={{ once: true, amount: 0.3 }}
            ...
            <motion.p
              className="text-center text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto text-lg"
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              viewport={{ once: true, amount: 0.3 }}
            ...
            >
              ...
              >
                <Link href="/contact">
                  <Button
                    variant="outline"
                    className="px-8 py-4 text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-400 hover:text-blue-500 dark:hover:text-blue-400 transition-all duration-300 rounded-md flex items-center gap-2 text-base"
                  >
